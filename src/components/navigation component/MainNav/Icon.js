...
export const Bag = () => {
    return <Link to="/" className="checkout" >
        <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" focusable="false" role="img"
        ...
        <span className="checkout_bagInside">0</span>
...
export const Search = () => {
    return <svg height="20" width="20" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"
                className="search_search" focusable="false" role="img" aria-labelledby="icon_:re:"
                aria-hidden="false"><title id="icon_:re:">Search</title>
        <path
...
export const Close = () => {
    return <svg height="20" width="20" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"
                className="search_closeIcon" focusable="false" role="img" aria-labelledby="icon_:rd:"
                aria-hidden="false" color="black">
