...
export const Login = (props) => {
  ...
  const handleSubmit = (evt) => {
    ...
    axios
      ...
      .catch((error) => {
        setErroMess(
          "Something's not right with your email address or password"
        );
      });
  };
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={5} style={{ marginTop: "20px" }}>
            <div className="login_menberShip">
              ...
              <p style={{ fontSize: "17px", margin: "20px 0 30px" }}>
            ...
            <div className="login_menberShip" style={{ marginTop: "40px" }}>
              ...
              >
                <Studio />
                <p style={{ fontSize: "17px", paddingLeft: "10px" }}>
                  Select lululemon Studio Content
                </p>
              </div>
              ...
              >
                <FastTrack />
                <p style={{ fontSize: "17px", paddingLeft: "10px" }}>
                  Receipt-Free and Fast-Track Returns
                </p>
              </div>
            ...
            <div style={{ margin: "10px 0" }} className="login_experienceMem">
              <p
                className="login_experienceMem_text"
                style={{ fontSize: "15px" }}
              >
          ...
          <Grid item xs={5} style={{ marginTop: "20px", maxWidth: "500px" }}>
            ...
            >
              ...
              <button
                type="submit"
                style={{ padding: "15px", margin: "20px 0", width: "100%" }}
              >
                SIGN IN
              </button>

              <p style={{ fontSize: "15px", color: "#57585B" }}>
                By signing in, you agree to the <span>Terms of Use</span> and
                acknowledge the <span>Privacy Policy</span>. California
                consumers, see our <span>Notice of Financial Incentives</span>.
              </p>
            </form>

            <hr />
            <div style={{ marginTop: "20px" }}>
              <span className="login_rightPart_create">
      ...
      <div className="loginPhone">
        <Grid item xs={12}>
          <div style={{ display: "flex", flexDirection: "row" }}>
            <h2 style={{ fontSize: "20px", paddingBottom: "10px" }}>
              Discover lululemon Membership.
            </h2>
          ...
          >
            ...
            <p style={{ fontSize: "15px", color: "#57585B" }}>
              By signing in, you agree to the <span>Terms of Use</span> and
              acknowledge the <span>Privacy Policy</span>. California consumers,
              see our <span>Notice of Financial Incentives</span>.
            </p>

            <h2 style={{ paddingTop: "20px" }}>Not a member yet?</h2>
            <p style={{ fontSize: "15px", padding: "10px 0" }}>
              Members get free hemming, exchange or credit on sale items, early
              access to product drops, and more.
            </p>
            <button
              style={{
