...
const ReviewFilter = () => {
        ...
        const ratingStar = [
            {id: 0, label: '5 Star', label1: '1', num: 5},
            {id: 1, label: '4 Star', label1: '1', num: 4},
            {id: 2, label: '3 Star', label1: '1', num: 3},
            {id: 3, label: '2 Star', label1: '1', num: 2},
            {id: 4, label: '1 Star', label1: '1', num: 1}
        ]
